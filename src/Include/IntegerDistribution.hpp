...
#pragma omp critical
	...
	public:
		...
		/**
		 *	Type parameter C is symbol type, e.g. char
		 *	Type parameter D is integral symbol distance type, e.g. Distance
		 *	Type parameter SymbolDistance is a functor: C \times C \to D.
		 */
