	...
	class SignatureHit {
...

		{
			for (auto hitIter = hits.begin(); hitIter != hits.end(); hitIter++) {
				...
				// TODO: this is wrong, I don't know what was going on here. Cross reference agains the C# version before using this code.
				throw Exception( "TODO: this is wrong, I don't know what was going on here. Cross reference agains the C# version before using this code.", __FILE__, __LINE__ );
